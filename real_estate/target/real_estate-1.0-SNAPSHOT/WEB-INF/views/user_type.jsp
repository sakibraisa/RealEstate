            ...
            <center>
                ...
                <form name="objForm" method="POST">
                    <table>
                        <tr><td colspan="2">
                                ...
                                <div ng-if="objCtrl.flag == 'edit'">
                                    <h3> Update User Type for ID: {{ objCtrl.obj.userTypeId}} </h3> 
                                </div> </td>
                        </tr>
                        <tr>
                            <td>User Type: </td> <td><input type="text" name="proType" ng-model="objCtrl.obj.userType" required/> 
                                <span ng-show="objForm.userType.$error.required" class="msg-val">User Name is required.</span> </td>
                        </tr>
                        <tr>
                            <td colspan="2"> <span ng-if="objCtrl.flag == 'created'" class="msg-success">User Name successfully added.</span>
                                <span ng-if="objCtrl.flag == 'failed'" class="msg-val">User Name already exists.</span> </td>
                        </tr>
                        <tr><td colspan="2">
                                <div ng-if="objCtrl.flag != 'edit'">
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <tr ng-repeat="row in objCtrl.objArray">
                        <td><span ng-bind="row.userTypeId"></span></td>
                        <td><span ng-bind="row.userType"></span></td>
                        <td>
                            <input type="button" ng-click="objCtrl.deleteObject(row.userTypeId)" value="Delete"/>
                            <input type="button" ng-click="objCtrl.editObject(row.userTypeId)" value="Edit"/>
                            <span ng-if="objCtrl.flag == 'updated' && row.userTypeId == objCtrl.updatedId" class="msg-success">User successfully updated.</span> </td> 
                    </tr>	
                </table>
            </center>
        </div>
