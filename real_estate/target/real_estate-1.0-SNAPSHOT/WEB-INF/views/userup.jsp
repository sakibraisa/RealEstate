...
<!--                        <tr>
                            <td>User ID</td>
                            <td>
                                <select ng-model="objCtrl.obj.userId" ng-options="x.userId for x in names">
                                </select>
                            </td>
                        </tr>-->
                        <tr>
...
<!----------->
                        ...
                        <tr>
                            <td colspan="2"> <span ng-if="objCtrl.flag == 'updated'" class="msg-success">User successfully updated.</span>
                        </tr>
