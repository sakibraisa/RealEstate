                ...
                <form name="objForm" method="POST">
                    <table>
                        ...
                        <tr>
                            <td>User</td>
                            <td>
                                <select ng-model="objCtrl.obj.user" ng-options="x.uname for x in names">
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td>Property Type</td>
                            <td>
                                <select ng-model="objCtrl.obj.proType" ng-options="x.proType for x in name">
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select ng-model="objCtrl.obj.paymentMethod" ng-options="x.payMethod for x in nam">
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td>Payment Type</td>
                            <td>
                                <select ng-model="objCtrl.obj.paymentType" ng-options="x.payType for x in na">
                                </select>
                            </td>
                        </tr>

                        <tr>
                            <td>Due Date: </td> <td> <input type="date" name="dueDate" ng-model="objCtrl.obj.dueDate" required/> 
                                <span ng-show="objForm.dueDate.$error.required" class="msg-val">Due Date is required.</span> </td>
                        </tr>
                        <tr>
                            <td>Due Amount: </td> <td><input type="text" name="dueAmount" ng-model="objCtrl.obj.dueAmount" required/> 
                                <span ng-show="objForm.dueAmount.$error.required" class="msg-val">Due Amount is required.</span> </td>
                        </tr>
                        <tr>
                            <td>Date Paid: </td> <td> <input type="date" name="datePaid" ng-model="objCtrl.obj.datePaid" required/> 
                                <span ng-show="objForm.datePaid.$error.required" class="msg-val">Date Paid is required.</span> </td>
                        </tr>
                        <tr>
                            <td>Amount Paid: </td> <td> <input type="text" name="amountPaid" ng-model="objCtrl.obj.amountPaid" required/> 
                         <span ng-show="objForm.amountPaid.$error.required" class="msg-val">Amount Paid is required.</span> </td>
                        </tr>
<!--                        <tr>
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    <tr align="center"><th>Booking ID </th>
                        <th>User</th>
                    ...
                    <tr ng-repeat="row in objCtrl.objArray" align="center">
                        ...
                        <td><span ng-bind="row.paymentMethod.payMethod"></span></td>
                        <td><span ng-bind="row.paymentType.payType"></span></td>
                        <td><span ng-bind="row.proType.proType"></span></td>
                        <td><span ng-bind="row.dueDate"></span></td>
                        <td><span ng-bind="row.dueAmount"></span></td>
                        <td><span ng-bind="row.datePaid"></span></td>
                        <td><span ng-bind="row.amountPaid"></span></td>
